      ...
      <div className="homeBody">
        ...
        <div className="investorBody contentBlock">
          <div className="investorTextContainer">
            <div className="investorTextTitle">
             Investor Relations Contact
           </div>
            <div className="investorTextBody">
              <div>
               For investor enquiries or to make a proposal, please contact
               us at investor-relations@halendr.com.
             </div>
              <div>
               Halendr Limited is registered under the laws of Hong Kong as a company limited by shares. <br />
               We do not issue stock and are not a public listed company.
             </div>
            </div>
          </div>
        </div>
